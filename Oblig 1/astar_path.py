'''
    ...
    Written by Bjornar Tessem, 17. August 2020
'''
...
class AStarPath:
    ...
    def __lt__(self,other):
        ...
        the h-value. Used for ranking the paths in the  PriorityQueue of the EightGameSpace solve
